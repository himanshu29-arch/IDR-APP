...
import { View, TouchableOpacity, StyleSheet, Image, Pressable, ScrollView, FlatList, Modal } from 'react-native';
...
const getVal = () => {
  ...
  return (
    <View style={{marginBottom: 5}}>
      {label && (
       <MyText style={{  color: AppColors.black }}>{label}</MyText>
      )}
      <View>
       {
        isDisabled ?
        <View style={isDarker ? styles.anotherC : styles.mainc}>
        <MyText fontType="medium" style={isDarker ? styles.anothertxt : styles.maintxt}>{getVal()}</MyText>
